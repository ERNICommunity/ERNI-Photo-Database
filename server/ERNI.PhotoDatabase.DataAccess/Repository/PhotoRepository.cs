...
namespace ERNI.PhotoDatabase.DataAccess.Repository
{
    internal class PhotoRepository : RepositoryBase, IPhotoRepository
    {
        ...
        public Photo StorePhoto(string fileName, Guid fullSizeBlobId, Guid thumbnailBlobId, Guid taggedThumbnailBlobId, string mime, int width, int height)
        {
            var photo = new Photo
            {
                Name = fileName,
                ...
                TaggedThumbnailImageId = taggedThumbnailBlobId,
                Mime = mime,
                Width = width,
                Height = height
            };
